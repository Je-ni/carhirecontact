...
<html lang="en">
  ...
  <body style='background-color: #DCDADA;'>
      ...
      <div class='row'>
          ...
          <div class="col-sm-8">
              <div class='contact'>
                  <h2 style="color:#436BC8;">Contact Form</h2>
              </div>
              <div style='padding: 2% 0;'>
                  <div>
                      <p style="font-size:15px; color:#000; "> <strong>We offer the following services swiftly:</strong></p>
                  </div>
                  ...
                  <div>
                      <p style="font-size:15px; color:#000; margin-top: 10px; padding-top: 10px;"> <strong>Are there still open questions? Please contact us.</strong></p>
                  </div>
              </div>
              <div id="formDiv">
                <form>
